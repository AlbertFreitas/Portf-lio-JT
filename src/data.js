...
// Importações das imagens das ferramentas
...
// NOVAS IMAGENS (adicione os ícones correspondentes na pasta /public/assets/tools/)
import Tools12 from "/assets/tools/express.png"; // Crie ou baixe um ícone para o Express.js
import Tools13 from "/assets/tools/sequelize.png"; // Crie ou baixe um ícone para o Sequelize
import Tools14 from "/assets/tools/prisma.png"; // Crie ou baixe um ícone para o Prisma
import Tools15 from "/assets/tools/postgresql.png"; // Crie ou baixe um ícone para o PostgreSQL
import Tools16 from "/assets/tools/mongodb.png"; // Crie ou baixe um ícone para o MongoDB


// ESTRUTURA DE DADOS PARA AS FERRAMENTAS (ATUALIZADA)
export const categorizedTools = [
  {
    category: "Linguagens",
    tools: [
      { id: 6, gambar: Tools6, nama: "Javascript", ket: "Linguagem de Programação", dad: "100" },
      { id: 3, gambar: Tools3, nama: "Typescript", ket: "Superset do Javascript", dad: "200" },
      { id: 5, gambar: Tools5, nama: "Python", ket: "Linguagem de Programação", dad: "300" },
    ],
  },
  {
    category: "Back-End",
    tools: [
      { id: 7, gambar: Tools7, nama: "Node.js", ket: "Ambiente de Execução", dad: "400" },
      { id: 12, gambar: Tools12, nama: "Express.js", ket: "Framework para APIs", dad: "450" },
      { id: 13, gambar: Tools13, nama: "Sequelize", ket: "ORM para Node.js", dad: "500" },
      { id: 14, gambar: Tools14, nama: "Prisma", ket: "ORM para Node.js", dad: "550" },
    ],
  },
  {
    category: "Front-End",
    tools: [
      { id: 2, gambar: Tools2, nama: "React.js", ket: "Biblioteca JavaScript", dad: "600" },
      { id: 4, gambar: Tools4, nama: "Tailwind CSS", ket: "Framework CSS", dad: "700" },
    ],
  },
  {
    category: "Bancos de Dados",
    tools: [
        { id: 15, gambar: Tools15, nama: "PostgreSQL", ket: "Banco de Dados SQL", dad: "800" },
        { id: 16, gambar: Tools16, nama: "MongoDB", ket: "Banco de Dados NoSQL", dad: "850" },
    ]
  },
  {
    category: "Ferramentas & Design",
    tools: [
      { id: 1, gambar: Tools1, nama: "VS Code", ket: "Editor de Código", dad: "900" },
      { id: 8, gambar: Tools8, nama: "Github", ket: "Controle de Versão", dad: "1000" },
      { id: 11, gambar: Tools11, nama: "Figma", ket: "Prototipagem e Design", dad: "1100" },
    ],
  },
];
