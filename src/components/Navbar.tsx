...
const Navbar = () => {
  ...
  return (
    <div
      className={`navbar px-4 sm:px-8 py-4 flex items-center justify-end z-50 ${
        active
          ? // AQUI ESTÁ A MUDANÇA! 👇 Adicionamos as classes de animação
            "fixed top-0 left-0 right-0 md:bg-zinc-950/80 md:backdrop-blur-sm md:shadow-xl animate__animated animate__fadeInDown animate__faster"
          : "relative"
      }`}
    >
      <ul
